...
import org.sonar.java.checks.xml.maven.Ezviz_FastjsonCheck;
...
public class EzvizMavenCheckTest {
    ...
    @Test
    public void fastjson_check(){
        PomCheckVerifier.verify("src/test/files/checks/xml/maven/EzvizMavenTestXML.xml", new Ezviz_FastjsonCheck());
    }
}
